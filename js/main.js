...
//     alphabetStr += `<button onclick="getByLetter('${alphabet[i]}')" class="btn text-white">${alphabet[i]}</button>`
// }
    ...
    if (listBy == "contact") {
		...
		<div class="p-2">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						<input onkeyup="validation()" class="form-control m-1" id="email" placeholder="Enter Email">
				...
				<div class="col-md-6">
					<div class="form-group">
						<input onkeyup="validation()" class="form-control m-1" id="phone" placeholder="Enter phone">
				...
				<div class="col-md-6">
					<div class="form-group">
						<input onkeyup="validation()" class="form-control m-1" id="age" placeholder="Enter Age">
				...
				<div class="col-md-6">
					<div class="form-group">
						<input onkeyup="validation()" class="form-control m-1" type="password" id="password"
				...
				<div class="col-md-6">
					<div class="form-group">
						<input onkeyup="validation()" class="form-control m-1" type="password" id="rePassword"
